 ...
 */
package com.bwf.aiyiqi.ui.view.indicator;
...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    private OnPagerChangeCallBack onPagerChangeCallBack;
    ...
    public void setOnPagerChangeCallBack(OnPagerChangeCallBack onPagerChangeCallBack) {
        this.onPagerChangeCallBack = onPagerChangeCallBack;
    }
    ...
    public void onPageSelected(int position) {
        ...
        if (onPagerChangeCallBack != null)
            onPagerChangeCallBack.onPageSelected(position);
    }
    ...
    public interface OnPagerChangeCallBack{
