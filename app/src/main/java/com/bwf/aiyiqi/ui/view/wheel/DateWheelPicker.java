package com.bwf.aiyiqi.ui.view.wheel;
...
import com.bwf.aiyiqi.ui.view.wheel.adapter.DateWheelAdapter;
...
public class DateWheelPicker extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        years.setVisibleItems(3);//设置显示年月日的个数，默认是5个
        months.setVisibleItems(3);//设置显示年月日的个数，默认是5个
        days.setVisibleItems(3);//设置显示年月日的个数，默认是5个
        addView(years);
        addView(months);
        addView(days);
    }
